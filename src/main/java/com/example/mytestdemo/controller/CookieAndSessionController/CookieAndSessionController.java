...
public class CookieAndSessionController {
    ...
    @GetMapping("/setSessionAndCookie")
    public void setSessionAndCookie(HttpServletRequest httpServletRequest, HttpServletResponse httpServletResponse){
        HttpSession session = httpServletRequest.getSession();session.setAttribute("user","15251800012");
